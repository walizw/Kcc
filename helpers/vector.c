...
static void
vector_assert_bounds_for_pop (struct vector *vector, int index)
{
  assert (vector_in_bounds_for_pop (vector, index));
}

struct vector *
vector_create_no_saves (size_t esize)
{
...
size_t
vector_total_size (struct vector *vector)
{
  return vector->count * vector->esize;
}

size_t
vector_element_size (struct vector *vector)
{
  return vector->esize;
}

struct vector *
vector_clone (struct vector *vector)
{
...
int
vector_current_index (struct vector *vector)
{
  return vector->rindex;
}

void
vector_resize_for_index (struct vector *vector, int start_index,
                         int total_elements)
{
...
void
vector_resize_for (struct vector *vector, int total_elements)
{
  vector_resize_for_index (vector, vector->rindex, total_elements);
}

void
vector_resize (struct vector *vector)
{
...
void *
vector_at (struct vector *vector, int index)
{
  return vector->data + (index * vector->esize);
}

void
vector_set_peek_pointer (struct vector *vector, int index)
{
  vector->pindex = index;
}

void
vector_set_peek_pointer_end (struct vector *vector)
{
  vector_set_peek_pointer (vector, vector->rindex - 1);
}

void *
vector_peek_at (struct vector *vector, int index)
{
...
void *
vector_peek_no_increment (struct vector *vector)
{
...
void
vector_peek_back (struct vector *vector)
{
  vector->pindex--;
}

void *
vector_peek (struct vector *vector)
{
...
void
vector_set_flag (struct vector *vector, int flag)
{
  vector->flags |= flag;
}

void
vector_unset_flag (struct vector *vector, int flag)
{
  vector->flags &= ~flag;
}

void *
vector_peek_ptr (struct vector *vector)
{
...
void *
vector_peek_ptr_at (struct vector *vector, int index)
{
...
void *
vector_back_ptr (struct vector *vector)
{
...
void
vector_save (struct vector *vector)
{
...
void
vector_restore (struct vector *vector)
{
...
void
vector_save_purge (struct vector *vector)
{
  vector_pop (vector->saves);
}

void
vector_pop_last_peek (struct vector *vector)
{
...
void
vector_push (struct vector *vector, void *elem)
{
...
int
vector_fread (struct vector *vector, int amount, FILE *fp)
{
...
const char *
vector_string (struct vector *vec)
{
  return vec->data;
}

void *
vector_data_end (struct vector *vector)
{
  return vector->data + vector->rindex * vector->esize;
}

size_t
vector_elements_left (struct vector *vector, int index)
{
  return vector->count - index;
}

int
vector_elements_until_end (struct vector *vector, int index)
{
  return vector->count - index;
}

void
vector_shift_right_in_bounds_no_increment (struct vector *vector, int index,
                                           int amount)
{
  ...
  memcpy (vector_at (vector, eindex), vector_at (vector, index),
          bytes_to_move);
  memset (vector_at (vector, index), 0x00, amount * vector->esize);
}

void
vector_shift_right_in_bounds (struct vector *vector, int index, int amount)
{
...
void
vector_stretch (struct vector *vector, int index)
{
...
int
vector_pop_value (struct vector *vector, void *val)
{
...
int
vector_pop_at_data_address (struct vector *vector, void *address)
{
...
void
vector_shift_right (struct vector *vector, int index, int amount)
{
  if (index < vector->rindex)
    {
...
void
vector_pop_at (struct vector *vector, int index)
{
...
void
vector_peek_pop (struct vector *vector)
{
  // Popping at a peek is an akward one
  // we will need to shift all the elements to the left, annoying...
  // This will also invalidate any pointers pointing directly to the vector
  // data
  vector_pop_at (vector, vector->pindex);
}

void
vector_push_multiple_at (struct vector *vector, int dst_index, void *ptr,
                         int total)
{
...
void
vector_push_at (struct vector *vector, int index, void *ptr)
{
...
int
vector_insert (struct vector *vector_dst, struct vector *vector_src,
               int dst_index)
{
...
void *
vector_data_ptr (struct vector *vector)
{
  return vector->data;
}
...
void *
vector_back_or_null (struct vector *vector)
{
...
void *
vector_back_ptr_or_null (struct vector *vector)
{
...
void *
vector_back (struct vector *vector)
{

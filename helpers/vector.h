...
struct vector
{
  ...
  // "vector_peek". This index will then be incremented
  int pindex;
  int rindex;
  int mindex;
  int count;
 ...
 * \param address The address that is part of the vector->data range to pop
 * off. \return Returns the index that we popped off.
 */
